...
public final class execute {
     ...
     * @throws IOException
     */
    private execute(String host, int port, String userName, String password)
     ...
     * @throws IOException
     */
    private execute(String host, int port, String userName, byte[] sshPrivateKey)
            throws JSchException, IOException {
        Closure expectClosure = getExpectClosure();
        for (String linuxPromptPattern : new String[]{"\\>", "#", "~#", "~\\$"}) {
            try {
     ...
     */
    public execute open(String host, int port, String userName, String password)
            throws JSchException, IOException {
        return new execute(host, port, userName, password);
    }
     ...
     * @throws IOException IO exception thrown
     */
    public execute open(String host, int port, String userName, byte[] sshPrivateKey)
            throws JSchException, IOException {
        return new execute(host, port, userName, sshPrivateKey);
    }
     ...
     *
     * @param fileName the name of the file for which the content will be
     * downloaded
     * @param fromPath the path of the file for which the content will be
     * downloaded
     * @param isUserHomeBased true if the path of the file is relative to the
     ...
     * @param fileName the name of the file for which the content will be saved
     * into
     * @param toPath the path of the file for which the content will be saved
     * into
     * @param isUserHomeBased true if the path of the file is relative to the
     * user's home directory
